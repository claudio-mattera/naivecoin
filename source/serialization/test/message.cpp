...
BOOST_AUTO_TEST_CASE(create_send_block_message)
{
    ...
    std::string const serialized = naivecoin::serialization::create_send_block_message(block, sender);
...
BOOST_AUTO_TEST_CASE(create_send_blockchain_message)
{
    ...
    std::string const serialized = naivecoin::serialization::create_send_blockchain_message(
...
BOOST_AUTO_TEST_CASE(create_query_latest_block_message)
{
    ...
    std::string const serialized = naivecoin::serialization::create_query_latest_block_message(sender);
...
BOOST_AUTO_TEST_CASE(create_query_blockchain_message)
{
    ...
    std::string const serialized = naivecoin::serialization::create_query_blockchain_message(sender);
...
BOOST_AUTO_TEST_CASE(process_message_send_block)
{
    ...
    std::string const message = naivecoin::serialization::create_send_block_message(original_block, original_sender);
    ...
    naivecoin::serialization::process_message(
        message,
...
BOOST_AUTO_TEST_CASE(process_message_send_blockchain)
{
    ...
    std::string const message = naivecoin::serialization::create_send_blockchain_message(
...
BOOST_AUTO_TEST_CASE(process_message_query_latest_block)
{
    ...
    std::string const message = naivecoin::serialization::create_query_latest_block_message(original_sender);
...
BOOST_AUTO_TEST_CASE(process_message_query_blockchain)
{
    ...
    std::string const message = naivecoin::serialization::create_query_blockchain_message(original_sender);
